...
namespace Client_Mobile.Interfaces
{
    ...
    interface IApiMatchingEndpoints
    {
        ...
        Task<HttpResponseMessage> CreateUser([Header("Accept")] string applicationJson, [Body(BodySerializationMethod.Json)]  StringContent body);
        ...
        Task<HttpResponseMessage> AddNewActionForLocker([Header("Accept")] string applicationJson, [Body(BodySerializationMethod.Json)]  StringContent body);
    }
}
